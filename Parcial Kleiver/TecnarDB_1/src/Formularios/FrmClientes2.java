...
public class FrmClientes2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Direccion", "Telefono", "Correo", "Username"
            }
        ));
        jScrollPane1.setViewportView(tableClientes);

        jLabel1.setText("DESARROLLADO POR: KLEIVER FAJARDO JULIO");

        jLabel2.setText("Creacion De Cliente");
    ...
    private void cargarClientes() {
        ...
        if (rs != null) {
            while (rs.next()) {
                ...
                model.addRow(new Object[]{id, nombre, apellido, direccion, telefono, correo, username});
            }
            rs.close();
        }
